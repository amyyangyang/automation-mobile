                    ...
                    try (InputStream input = new FileInputStream("target//upload//test-classes//application.properties")) {
                        ...
                        switch (prop.getProperty("platform.name")) {
                            case "android":
                                ...
                                capabilities.setCapability("waitForQuiescence", "false");
                                    switch (prop.getProperty("env.name")) {
                                        case "dev":
                                            capabilities.setCapability("app", "D:\\app\\NEXT DEV.apk_2.0.9.apk");
                                            capabilities.setCapability("appPackage", "com.nexttrucking.trucker.dev");
                                            break;
                                        case "test":
                                            capabilities.setCapability("app", "D:\\app\\NEXT TEST.apk_2.0.9.apk");
                                            capabilities.setCapability("appPackage", "com.nexttrucking.trucker.testing");
                                            break;
                                        case "demo":
                                            capabilities.setCapability("app", "D:\\app\\NEXT DEMO.apk_2.0.9.apk");
                            ...
                            case "ios":
                                ...
                                capabilities.setCapability(MobileCapabilityType.APP, "/Users/nexttrucking/NEXT DEV.ipa_2.0.9.ipa");
