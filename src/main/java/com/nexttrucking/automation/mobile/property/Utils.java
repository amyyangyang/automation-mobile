...
public class Utils {
    ...
    public static List<String> equipmentTypeList = new ArrayList<String>(asList("ROUNDTRIP  |  DRY VAN", "DROP & HOOK  |  POWER ONLY","PORT  |  POWER ONLY", "ROUNDTRIP  |  POWER ONLY", "MULTI-STOP  |  POWER ONLY", "DROP & HOOK  |  DRY VAN", "MULTI-STOP  |  DRY VAN", "DRY VAN", "POWER ONLY", "REEFER", "BOX TRUCK", "LOADSPEC.PORT  |  POWER ONLY", "MULTI-STOP  |  POWER ONLY", "DRAYAGE  |  POWER ONLY"));
