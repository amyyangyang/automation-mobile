...
public class Utils {
    ...
    public static List<String> equipmentTypeList = new ArrayList<String>(asList("ROUNDTRIP  |  DRY VAN","DROP & HOOK  |  POWER ONLY","ROUNDTRIP  |  POWER ONLY","MULTISTOP  |  POWER ONLY","DROP & HOOK  |  DRY VAN","MULTISTOP  |  DRY VAN","DRY VAN","POWER ONLY", "REEFER", "BOX TRUCK"));
